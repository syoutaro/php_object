...
<div id="wrap">
  ...
  <div id="content">
    ...
    <div class="msg">
      <img src="member_picture/<?php echo h($post['picture'], ENT_QUOTES, 'UTF-8'); ?>" width="48" height="48" alt="<?php echo h($post['name'], ENT_QUOTES); ?>" />
      <p><?php echo h($post['message'], ENT_QUOTES);?><span class="name">（<?php echo h($post['name'], ENT_QUOTES); ?>）</span>
      [<a href="index.php?res=<?php echo h($post['id'], ENT_QUOTES); ?>">Re</a>]</p>
      <p class="day">
    <a href="view.php?id=<?php echo h($post['id'], ENT_QUOTES); ?>">
        <?php echo h($post['created'], ENT_QUOTES); ?></a>
  </p>
    ...
    <ul class="paging">
    <?php if ($page > 1) : ?>
    <li><a href="index.php?page=<?php echo($page - 1); ?>">前のページ</a></li>
    <?php else : ?>
    <li>前のページへ</li>
    <?php endif; ?>
    <?php if ($page < $maxPage) : ?>
    <li><a href="index.php?page=<?php echo($page + 1); ?>">次のページ</a></li>
    <?php else : ?>
    <li>次のページへ</li>
    <?php endif; ?>
    </ul>
